namespace(:dependencies) do
  namespace(:tk) do
    ...
    task :install22 => [:activate, RubyInstaller::Ruby22.install_target, *package.dependencies] do
      tcltk_install RubyInstaller::Ruby22
      tk_patch package, RubyInstaller::Ruby22
    end
