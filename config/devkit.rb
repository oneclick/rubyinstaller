...
module DevKitInstaller
  ...
  MSYS = OpenStruct.new(
    ...
    :files => {
      :url_1 => [
        'msys2-runtime-2.0.16224.6393980-4-i686.pkg.tar.xz',
        'filesystem-2014.09-2-i686.pkg.tar.xz',
        ...
        'bash-4.3.028-1-i686.pkg.tar.xz',
        'coreutils-8.23-2-i686.pkg.tar.xz',
        'grep-2.19-1-i686.pkg.tar.xz',
        'libpcre-8.36-1-i686.pkg.tar.xz',
        ...
        'less-466-1-i686.pkg.tar.xz',
        'findutils-4.5.14-1-i686.pkg.tar.xz',
        'perl-5.20.1-1-i686.pkg.tar.xz',
        ...
        'libarchive-3.1.2-3-i686.pkg.tar.xz',
        'libbz2-1.0.6-1-i686.pkg.tar.xz',
        'liblzma-5.0.5-1-i686.pkg.tar.xz',
        'liblzo2-2.08-1-i686.pkg.tar.xz',
        'libnettle-2.7.1-1-i686.pkg.tar.xz',
        'libxml2-2.9.1-5-i686.pkg.tar.xz',
