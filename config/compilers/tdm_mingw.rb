module DevKitInstaller
  ...
  COMPILERS['tdm-32-4.7.1'] =
    OpenStruct.new(
      :version => 'tdm-32-4.7.1',
      :programs => [ :gcc, :cpp, :'g++' ],
      :program_prefix => nil,
  ...
  COMPILERS['tdm-64-4.7.1'] =
    OpenStruct.new(
      :version => 'tdm-64-4.7.1',
      :programs => [ :gcc, :cpp, :'g++' ],
      :program_prefix => nil,
      :url_1 => 'http://downloads.sourceforge.net/tdm-gcc',
      :url_2 => 'http://downloads.sourceforge.net/mingw',
      ...
      :files => {
        :url_1 => [
          'gcc-4.7.1-tdm64-1-core.tar.lzma',
          'gcc-4.7.1-tdm64-1-c++.tar.lzma',
          'binutils-2.22.90-tdm64-1.tar.lzma',
          'mingw64-runtime-tdm64-gcc47-svn5385.tar.lzma',
          'gdb-7.5-tdm64-1.tar.lzma',
        ],
        :url_2 => [
          'autoconf2.1-2.13-4-mingw32-bin.tar.lzma',
          'autoconf2.5-2.68-1-mingw32-bin.tar.lzma',
