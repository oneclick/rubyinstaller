...
mingw64      mingw64-32-4.9.2, mingw64-64-4.9.2, mingw64-32-4.9.1, mingw64-64-4.9.1, mingw64-32-4.9.0, mingw64-64-4.9.0, mingw64-32-4.8.2, mingw64-64-4.8.2, mingw64-32-4.7.2, mingw64-64-4.7.2
mingwbuilds  mingwbuilds-32-4.7.2

(*) = default build toolchain

At any time you can list the available (official and unofficial) DevKit compiler
toolchains by running `rake devkit:ls`.
