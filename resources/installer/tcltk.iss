...
; License: MIT
; Revision: 05/31/2011 9:48:31 AM
...
Source: {#RubyPath}\..\tcl\lib\*; DestDir: {app}\lib; Excludes: "*.a,*.sh"; Flags: recursesubdirs createallsubdirs; Check: IsTclTk
Source: {#RubyPath}\..\tk\lib\*; DestDir: {app}\lib; Excludes: "*.a,*.sh"; Flags: recursesubdirs createallsubdirs; Check: IsTclTk
